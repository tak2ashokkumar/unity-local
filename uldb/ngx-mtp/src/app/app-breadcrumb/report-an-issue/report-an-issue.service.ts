...
import { CREATE_REPORT_AN_ISSUE } from 'src/app/shared/api-endpoint.const';
import { MS_DYNAMICS_TICKET_TYPE, NoWhitespaceValidator } from 'src/app/shared/app-utility/app-utility.service';
...
export class ReportAnIssueService {
  ...
  buildReportIssueForm(breadCrumbs: string[], metadata: string) {
    return this.builder.group({
      ...
      'type': [MS_DYNAMICS_TICKET_TYPE.PROBLEM, NoWhitespaceValidator],
