...
import { AIMLAlertDetailsViewData, MtpAimlAlertDetailsService } from './mtp-aiml-alert-details.service';
...
@Component({
  selector: 'mtp-aiml-alert-details',
  templateUrl: './mtp-aiml-alert-details.component.html',
  styleUrls: ['./mtp-aiml-alert-details.component.scss']
})
export class MtpAimlAlertDetailsComponent implements OnInit {
  ...
  constructor(private alertDetailService: MtpAimlAlertDetailsService,
