...
import { MtpAimlSuppressionRulesCrudService, SuppressionConditionDropdown, suppressionConditionDropdownData } from './mtp-aiml-suppression-rules-crud.service';
...
@Component({
  selector: 'mtp-aiml-suppression-rules-crud',
  templateUrl: './mtp-aiml-suppression-rules-crud.component.html',
  styleUrls: ['./mtp-aiml-suppression-rules-crud.component.scss'],
  providers: [{ provide: DateTimeAdapter, useClass: MomentDateTimeAdapter, deps: [OWL_DATE_TIME_LOCALE], },
  { provide: OWL_DATE_TIME_FORMATS, useValue: MY_NATIVE_FORMATS },
    MtpAimlSuppressionRulesCrudService]
})
export class MtpAimlSuppressionRulesCrudComponent implements OnInit, OnDestroy {
  ...
  constructor(private crudSvc: MtpAimlSuppressionRulesCrudService,
  ...
  goBack() {
    this.router.navigate(['suppressionrules'], { relativeTo: this.route.parent });
  }
