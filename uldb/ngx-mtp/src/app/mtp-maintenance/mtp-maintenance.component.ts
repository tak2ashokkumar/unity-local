...
import { MaintenanceInstanceViewData, MtpMaintenanceService } from './mtp-maintenance.service';
import moment from 'moment';
import { ActivatedRoute, Router } from '@angular/router';

@Component({
  selector: 'mtp-maintenance',
  templateUrl: './mtp-maintenance.component.html',
  styleUrls: ['./mtp-maintenance.component.scss'],
  providers: [MtpMaintenanceService]

})
export class MtpMaintenanceComponent implements OnInit, OnDestroy {
  ...
  constructor(private spinner: AppSpinnerService, private router: Router,
    ...
    private svc: MtpMaintenanceService,
  ...
  getTenants() {
    this.tenantList = [];
    this.svc.getTenants().pipe(takeUntil(this.ngUnsubscribe)).subscribe(data => {
