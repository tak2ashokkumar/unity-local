...
@Injectable()
export class MtpTenantsMgmtDetailsMapService {
  TILE_SIZE = 256;

  constructor(private http: HttpClient,
    private appService: AppLevelService) { }

  getWidgetTenantsDCStatus(tenantId: string): Observable<any[]> {
    return this.http.get<WorldMapWidgetDatacenterLocation[]>(LOCATION_STATUS(tenantId));
  }
