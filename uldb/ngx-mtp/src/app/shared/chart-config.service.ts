...
export class ChartConfigService {
  ...
  getLegendLabels(chart: Chart, labelWidth: number, format?: boolean): ChartLegendLabelItem[] {
...
export const MAJOR_COLOR_CODES: string[] = [
  '#CC0000', // red - danger
  '#FF8800', // amber - warning
  '#0B69C2', // blue - primary
  '#0CBB70', // green - success
]

export const NON_RELATED_COLOR_CODES: string[] = [
  '#FF7F50', // coral
  '#008080', //teal
  '#7B3F00', //chocolate
  '#8e4585', //plum
