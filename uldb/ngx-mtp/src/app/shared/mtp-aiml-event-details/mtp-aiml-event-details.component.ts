...
import { AIMLEventDetailsViewData, MtpAimlEventDetailsService } from './mtp-aiml-event-details.service';
...
@Component({
  selector: 'mtp-aiml-event-details',
  templateUrl: './mtp-aiml-event-details.component.html',
  styleUrls: ['./mtp-aiml-event-details.component.scss']
})
export class MtpAimlEventDetailsComponent implements OnInit, OnDestroy {
  ...
  constructor(private detailService: MtpAimlEventDetailsService,
