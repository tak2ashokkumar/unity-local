...
/**
 * Monolithic dashboard component for the Bank of Anthos application.
  ...
  getCategoriesViewedWidgetViewData() {
    ...
    this.svc.getCategoriesViewedWidgetViewData(this.appId, this.filters)
      ...
      .subscribe(res => {
        ...
        this.spinner.stop(this.categoriesViewedWidgetViewData.loader);
        this.notification.error(new Notification('Failed to get User Journey data. Try again later'));
      });
  }
