...
import { ResourceCostItemViewData, ResourceLevelCostSummaryViewData, ResourceLevelDashboardService } from './resource-level-dashboard.service';
import { PAGE_SIZES, SearchCriteria } from 'src/app/shared/table-functionality/search-criteria';
import { Subject } from 'rxjs';
import { AccountFilterItem } from 'src/app/shared/SharedEntityTypes/dashboard/cost-summary-dashboard.type';
...
@Component({
  selector: 'resource-level-dashboard',
  templateUrl: './resource-level-dashboard.component.html',
  styleUrls: ['./resource-level-dashboard.component.scss'],
  providers: [ResourceLevelDashboardService]
})
export class ResourceLevelDashboardComponent implements OnInit {
  ...
  constructor(private svc: ResourceLevelDashboardService,
