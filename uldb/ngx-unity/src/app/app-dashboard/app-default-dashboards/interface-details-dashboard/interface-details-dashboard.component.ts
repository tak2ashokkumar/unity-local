...
import { InfrastructureInterfaceDetails } from 'src/app/shared/SharedEntityTypes/dashboard/interface-details-dashboard.type';
import { UnityChartData } from 'src/app/shared/chart-config.service';
import { FormGroup } from '@angular/forms';

// this component is currenlty used for the network devices such as switch,firewall,loadbalancer in dashboard for interface details.

@Component({
  selector: 'interface-details-dashboard',
  templateUrl: './interface-details-dashboard.component.html',
  styleUrls: ['./interface-details-dashboard.component.scss'],
  providers: [InterfaceDetailsDashboardService]
})
export class InterfaceDetailsDashboardComponent implements OnInit {
  ...
  constructor(private router: Router,
    ...
    private svc: InterfaceDetailsDashboardService,
  ...
  getInterfaceDetails() {
    this.svc.getInterfaceDetails(this.interfaceId).pipe(takeUntil(this.ngUnsubscribe)).subscribe(data => {
