...
import { InfrastructureDeviceInterface, InfrastructureInterfaceAlerts, InfrastructureInterfaceDetails, InfrastructureRecentAlerts } from 'src/app/shared/SharedEntityTypes/dashboard/interface-details-dashboard.type';

@Injectable()
export class InterfaceDetailsDashboardService {
  ...
  getInterfaceDetails(interfaceId: string): Observable<InfrastructureInterfaceDetails> {
