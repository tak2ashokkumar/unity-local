...
import { IOTDevicesAirflowWidgetViewData, IOTDevicesHumidityWidgetViewData, IOTDevicesRecentEventsViewData, IOTDevicesStatusByGroupData, IOTDevicesStatusByGroupViewData, IotDevicesSummaryDashboardService, IOTDevicesSummaryViewData, IOTDevicesTemperatureWidgetViewData, IotDevicesTypes, RecentModifiedRFIDTagsViewData, SmartPDUViewData } from './iot-devices-summary-dashboard.service';
...
@Component({
  selector: 'iot-devices-summary-dashboard',
  templateUrl: './iot-devices-summary-dashboard.component.html',
  styleUrls: ['./iot-devices-summary-dashboard.component.scss'],
  providers: [IotDevicesSummaryDashboardService]
})
export class IotDevicesSummaryDashboardComponent implements OnInit {
  ...
  constructor(private svc: IotDevicesSummaryDashboardService,
