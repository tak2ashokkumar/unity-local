...
import { IotDeviceType } from 'src/app/united-cloud/shared/entities/iot-device.type';
import * as echarts from 'echarts';
import { UNITY_FONT_FAMILY, UNITY_TEXT_DEFAULT_COLOR } from 'src/app/app-constants';

@Injectable()
export class IotDevicesSummaryDashboardService {
