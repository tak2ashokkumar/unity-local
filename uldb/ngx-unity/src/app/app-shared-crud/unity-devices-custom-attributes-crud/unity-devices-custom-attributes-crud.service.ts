...
import { DeviceCustomAttribute } from '../../shared/SharedEntityTypes/device-custom-attributes.type';
import { AppUtilityService, DeviceMapping, NoWhitespaceValidator } from '../../shared/app-utility/app-utility.service';
import { CUSTOM_ATTRIBUTES_FAST_BY_DEVICE_TYPE, DEVICE_CUSTOM_ATTRIBUTES_BY_DEVICE_ID } from '../../shared/api-endpoint.const';
