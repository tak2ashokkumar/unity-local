...
import { DEVICES_FAST_BY_DEVICE_TYPE, GET_AGENT_CONFIGURATIONS, GET_ONTAP_CLUSTER, SAVE_ONTAP_CLUSTER, TENANT_TEMPLATES } from '../../shared/api-endpoint.const';
...
export class UsiOntapCrudNewService {
