...
@Directive({
    selector: '[appWidgetLazyLoader]'
})
export class AppWidgetLazyLoaderDirective implements OnInit {

    @Input('appWidgetLazyLoader') input?: { ttw: number, option: IntersectionObserverInit };
