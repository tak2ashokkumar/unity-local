...
export enum DeviceMapping {
  ...
  KUBERNETES_ACCOUNT = 'Kubernetes Account',
  ...
  KUBERNETES_CONTROLPLANE = 'Kubernetes Control Plane',
  KUBERNETES_STORAGECLASS = 'Kubernetes Storage Class',
  KUBERNETES_JOB = 'Kubernetes Job',
  KUBERNETES_CRONJOB = 'Kubernetes CronJob',
  KUBERNETES_RESOURCEQUOTA = 'Kubernetes Resource Quota',
