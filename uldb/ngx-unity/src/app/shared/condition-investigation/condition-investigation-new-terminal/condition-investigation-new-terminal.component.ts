...
@Component({
  selector: 'condition-investigation-new-terminal',
  templateUrl: './condition-investigation-new-terminal.component.html',
  styleUrls: ['./condition-investigation-new-terminal.component.scss']
})
export class ConditionInvestigationNewTerminalComponent implements OnInit, OnDestroy {
  @Input() config: any;
