...
import { ConditionInvestigationZabbixGraphsService, DateRange, ZabbixGraphTimeRange, ZabbixMonitoringItemsViewdata } from './condition-investigation-zabbix-graphs.service';
...
export class ConditionInvestigationZabbixGraphsComponent implements OnInit, OnDestroy {
  ...
  constructor(private svc: ConditionInvestigationZabbixGraphsService,
