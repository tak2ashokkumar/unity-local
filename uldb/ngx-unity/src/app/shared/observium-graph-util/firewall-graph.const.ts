...
export const FIREWALL_OBSERVIUM_GRAPH: DeviceGraphConfig = {
    GRAPH: {
        FIREWALL: [
            {
                label: 'IPSec Tunnel Traffic Volume',
                graphType: 'device_cipsec_flow_bits',
                deviceType: null,
                deviceId: '',
            },
            {
                label: 'IPSec Tunnel Traffic Packets',
                graphType: 'device_cipsec_flow_pkts',
                deviceType: null,
                deviceId: '',
            },
            {
                label: 'IPSec Tunnel Statistics',
                graphType: 'device_cipsec_flow_stats',
                deviceType: null,
                deviceId: '',
            },
            {
                label: 'IPSec Active Tunnels',
                graphType: 'device_cipsec_flow_tunnels',
                deviceType: null,
                deviceId: '',
            },
            {
                label: 'Remote Access Sessions',
                graphType: 'device_cras_sessions',
                deviceType: null,
                deviceId: '',
            },
            {
                label: 'Firewall Sessions (IPv4)',
                graphType: 'device_firewall_sessions_ipv4',
                deviceType: null,
                deviceId: '',
            }
        ],
