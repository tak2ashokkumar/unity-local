...
import { DeviceMonitoringSNMPCrudType } from '../SharedEntityTypes/devices-monitoring.type';
import { AuthLevelMapping, NoWhitespaceValidator, SNMPVersionMapping } from '../app-utility/app-utility.service';
import { MonitoringTemplate } from '../SharedEntityTypes/monitoring-templates.type';
import { TENANT_TEMPLATES } from '../api-endpoint.const';
