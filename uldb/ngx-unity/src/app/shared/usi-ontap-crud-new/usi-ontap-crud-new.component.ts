...
import { UsiOntapCrudNewService } from './usi-ontap-crud-new.service';
...
import { OntapCrudFormdata } from '../usi-ontap-crud/usi-ontap-crud.service';
...
@Component({
  selector: 'usi-ontap-crud-new',
  templateUrl: './usi-ontap-crud-new.component.html',
  styleUrls: ['./usi-ontap-crud-new.component.scss']
})
export class UsiOntapCrudNewComponent implements OnInit {
  ...
  constructor(private spinner: AppSpinnerService,
    ...
    private crudSvc: UsiOntapCrudNewService,
  ...
  ngOnInit(): void {
    ...
    this.route.paramMap.subscribe((params: ParamMap) => {
      this.uuid = params.get('deviceId');
      this.actionMessage = this.uuid ? 'Edit' : 'Add';
      if(this.uuid){
        this.edit(this.uuid);
      }else{
        this.add();
