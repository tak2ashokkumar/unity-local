...
@Component({
  selector: 'datacenter-pdus-zabbix',
  templateUrl: './datacenter-pdus-zabbix.component.html',
  styleUrls: ['./datacenter-pdus-zabbix.component.scss']
})
export class DatacenterPdusZabbixComponent implements OnInit, OnDestroy {
