...
import { NetworkSummary, NetworkSummaryAlertsBySeverity, NetworkSummaryAlertsDetails, NetworkSummaryInterfaceDetails, NetworkSummaryInterfaceSummary, NetworkSummaryModels, NetworkSummaryStatusByGroup, Top10Utilization } from './infrastructure-network-devices.typs';

@Injectable()
export class InfrastructureNetworkDevicesService {
  ...
  getInterfaceSummaryData(criteria: SearchCriteria): Observable<NetworkSummaryInterfaceSummary> {
    // return this.tableService.getData<NetworkSummaryInterfaceSummary>(GET_NETWORK_SUMMARY_INTERFACE_DETAILS(), criteria);
