...
import { PublicCloudOciStorageServiceFilesService, PublicCloudOCIBucketFileView } from './public-cloud-oci-storage-service-files.service';
...
@Component({
  selector: 'public-cloud-oci-storage-service-files',
  templateUrl: './public-cloud-oci-storage-service-files.component.html',
  styleUrls: ['./public-cloud-oci-storage-service-files.component.scss'],
  providers: [PublicCloudOciStorageServiceFilesService]
})
export class PublicCloudOciStorageServiceFilesComponent implements OnInit, OnDestroy {
  ...
  constructor(private fileService: PublicCloudOciStorageServiceFilesService,
