...
import { ZabbixAwsMonitoringConfigService } from './zabbix-aws-monitoring-config/zabbix-aws-monitoring-config.service';
...
@Component({
  selector: 'aws-zabbix',
  templateUrl: './aws-zabbix.component.html',
  styleUrls: ['./aws-zabbix.component.scss']
})
export class AwsZabbixComponent implements OnInit, OnDestroy {
  ...
  constructor(private router: Router,
    ...
    private configSvc: ZabbixAwsMonitoringConfigService,
  ...
  loadTabs() {
    ...
    if (this.device.deviceType == DeviceMapping.AWS_ACCOUNTS) {
