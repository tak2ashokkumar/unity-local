...
import { ZabbixAwsMonitoringConfigService } from './zabbix-aws-monitoring-config.service';
...
@Component({
  selector: 'zabbix-aws-monitoring-config',
  templateUrl: './zabbix-aws-monitoring-config.component.html',
  styleUrls: ['./zabbix-aws-monitoring-config.component.scss'],
})
export class ZabbixAwsMonitoringConfigComponent implements OnInit, OnDestroy {
  monitoringDetails: AwsZabbixMonitoringConfig;
  ...
  constructor(private configSvc: ZabbixAwsMonitoringConfigService,
