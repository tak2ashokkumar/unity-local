...
import { ZabbixAzureMonitoringConfigService } from './zabbix-azure-monitoring-config.service';
...
@Component({
  selector: 'zabbix-azure-monitoring-config',
  templateUrl: './zabbix-azure-monitoring-config.component.html',
  styleUrls: ['./zabbix-azure-monitoring-config.component.scss']
})
export class ZabbixAzureMonitoringConfigComponent implements OnInit {
  monitoringDetails: AzureMonitoringConfig;
  ...
  constructor(private configSvc: ZabbixAzureMonitoringConfigService,
