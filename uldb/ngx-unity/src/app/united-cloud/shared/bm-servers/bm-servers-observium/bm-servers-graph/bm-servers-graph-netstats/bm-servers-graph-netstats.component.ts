...
@Component({
  selector: 'bm-servers-graph-netstats',
  templateUrl: './bm-servers-graph-netstats.component.html',
  styleUrls: ['./bm-servers-graph-netstats.component.scss']
})
export class BmServersGraphNetstatsComponent implements OnInit {

  graphConfig: DeviceGraphType[] =  BMS_OBSERVIUM_GRAPH.GRAPH['NETSTAT'];
  deviceId: string;
