...
@Component({
  selector: 'bm-server-port-usage-graphs',
  templateUrl: './bm-server-port-usage-graphs.component.html',
  styleUrls: ['./bm-server-port-usage-graphs.component.scss']
})
export class BmServerPortUsageGraphsComponent implements OnInit {
