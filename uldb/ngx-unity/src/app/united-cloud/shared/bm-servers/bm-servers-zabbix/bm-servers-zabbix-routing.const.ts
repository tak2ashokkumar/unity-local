...
import { BmServersMonitoringConfigComponent } from '../bm-servers-monitoring-config/bm-servers-monitoring-config.component';
import { ZabbixBmsDetailsComponent } from './zabbix-bms-details/zabbix-bms-details.component';
...
export const ZABBIX_BMS_ROUTES: Routes = [
  {
    path: 'details',
    component: ZabbixBmsDetailsComponent,
    data: {
      breadcrumb: {
        title: 'Details',
        stepbackCount: 0
  ...
  {
    path: 'configure',
    component: BmServersMonitoringConfigComponent,
    data: {
      breadcrumb: {
        title: 'Configuration',
        stepbackCount: 0
