...
// import { ZabbixFirewallDetailsComponent } from './zabbix-firewall-details/zabbix-firewall-details.component';
// import { ZabbixFirewallsGraphsComponent } from "./zabbix-firewalls-graphs/zabbix-firewalls-graphs.component";
...
export const ZABBIX_CONTAINER_CONTROLLER_ROUTES: Routes = [
  //   {
  //     path: 'details',
  //     component: ZabbixFirewallDetailsComponent,
  //     data: {
  //       breadcrumb: {
  //         title: 'Details',
  //         stepbackCount: 0
