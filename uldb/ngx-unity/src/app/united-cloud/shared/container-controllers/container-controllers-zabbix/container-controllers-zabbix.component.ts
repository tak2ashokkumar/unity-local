...
@Component({
  selector: 'container-controllers-zabbix',
  templateUrl: './container-controllers-zabbix.component.html',
  styleUrls: ['./container-controllers-zabbix.component.scss']
})
export class ContainerControllersZabbixComponent implements OnInit, OnDestroy {
