...
import { DeviceMapping, AppUtilityService, DeviceStatusMapping } from 'src/app/shared/app-utility/app-utility.service';
import { TabData } from 'src/app/shared/tabdata';
import { DatabaseMonitoringConfigService } from './database-monitoring-config/database-monitoring-config.service';
import { takeUntil } from 'rxjs/operators';
import { Subject } from 'rxjs';
import { SharedMonitoringService } from 'src/app/shared/shared-monitoring.service';

@Component({
  selector: 'database-monitoring',
  templateUrl: './database-monitoring.component.html',
  styleUrls: ['./database-monitoring.component.scss'],
  providers: [DatabaseMonitoringConfigService]
})
export class DatabaseMonitoringComponent implements OnInit, OnDestroy {
  ...
  constructor(private router: Router,
    ...
    private configSvc: DatabaseMonitoringConfigService,
  ...
  ngOnDestroy() {
    ...
    // this.storageService.removeByKey('deviceName', StorageType.SESSIONSTORAGE);
  }
