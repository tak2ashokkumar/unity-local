...
@Component({
  selector: 'firewalls-graph-firewall',
  templateUrl: './firewalls-graph-firewall.component.html',
  styleUrls: ['./firewalls-graph-firewall.component.scss']
})
export class FirewallsGraphFirewallComponent implements OnInit {
  graphConfig: DeviceGraphType[] = FIREWALL_OBSERVIUM_GRAPH.GRAPH['FIREWALL'];
  deviceId: string;
