...
@Component({
  selector: 'firewalls-health-overview',
  templateUrl: './firewalls-health-overview.component.html',
  styleUrls: ['./firewalls-health-overview.component.scss']
})
export class FirewallsHealthOverviewComponent implements OnInit {
  graphConfig: DeviceGraphType[] = FIREWALL_OBSERVIUM_GRAPH.HEALTHGRAPHS['OVERVIEW'];
  deviceId: string;
