...
@Component({
  selector: 'firewalls-zabbix',
  templateUrl: './firewalls-zabbix.component.html',
  styleUrls: ['./firewalls-zabbix.component.scss']
})
export class FirewallsZabbixComponent implements OnInit, OnDestroy {
