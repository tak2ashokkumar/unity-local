...
import { ZabbixGcpMonitoringConfigService } from './zabbix-gcp-monitoring-config/zabbix-gcp-monitoring-config.service';

@Component({
  selector: 'gcp-zabbix',
  templateUrl: './gcp-zabbix.component.html',
  styleUrls: ['./gcp-zabbix.component.scss']
})
export class GcpZabbixComponent implements OnInit, OnDestroy {
  ...
  constructor(private router: Router,
    ...
    private configSvc: ZabbixGcpMonitoringConfigService,
  ...
  loadTabs() {
    ...
    if (this.device.deviceType == DeviceMapping.GCP_ACCOUNTS) {
