...
@Component({
  selector: 'hypervisor-health-overview',
  templateUrl: './hypervisor-health-overview.component.html',
  styleUrls: ['./hypervisor-health-overview.component.scss']
})
export class HypervisorHealthOverviewComponent implements OnInit {

  graphConfig: DeviceGraphType[] = HYPERVISOR_OBSERVIUM_GRAPH.HEALTHGRAPHS['OVERVIEW'];
  deviceId: string;
