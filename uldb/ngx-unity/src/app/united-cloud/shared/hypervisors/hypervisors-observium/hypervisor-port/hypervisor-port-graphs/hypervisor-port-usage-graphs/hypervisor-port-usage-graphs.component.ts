...
@Component({
  selector: 'hypervisor-port-usage-graphs',
  templateUrl: './hypervisor-port-usage-graphs.component.html',
  styleUrls: ['./hypervisor-port-usage-graphs.component.scss']
})
export class HypervisorPortUsageGraphsComponent implements OnInit {
