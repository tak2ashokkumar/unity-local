...
import { ZabbixHypervisorDetailsComponent } from './zabbix-hypervisor-details/zabbix-hypervisor-details.component';
...
export const ZABBIX_HYPERVISOR_ROUTES: Routes = [
  {
    path: 'details',
    component: ZabbixHypervisorDetailsComponent,
    data: {
      breadcrumb: {
        title: 'Details',
        stepbackCount: 0
