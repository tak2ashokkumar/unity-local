...
@Component({
  selector: 'hypervisors-zabbix',
  templateUrl: './hypervisors-zabbix.component.html',
  styleUrls: ['./hypervisors-zabbix.component.scss']
})
export class HypervisorsZabbixComponent implements OnInit, OnDestroy {
