...
import { RfidReaderType, ZabbixIotDeviceRfidReaderDetailsService } from './zabbix-iot-device-rfid-reader-details.service';
...
@Component({
  selector: 'zabbix-iot-device-rfid-reader-details',
  templateUrl: './zabbix-iot-device-rfid-reader-details.component.html',
  styleUrls: ['./zabbix-iot-device-rfid-reader-details.component.scss'],
  providers: [ZabbixIotDeviceRfidReaderDetailsService]
})
export class ZabbixIotDeviceRfidReaderDetailsComponent implements OnInit, OnDestroy {
  ...
  constructor(private svc: ZabbixIotDeviceRfidReaderDetailsService,
