...
@Component({
  selector: 'loadbalancers-overview',
  templateUrl: './loadbalancers-overview.component.html',
  styleUrls: ['./loadbalancers-overview.component.scss']
})
export class LoadbalancersOverviewComponent implements OnInit, OnDestroy {
