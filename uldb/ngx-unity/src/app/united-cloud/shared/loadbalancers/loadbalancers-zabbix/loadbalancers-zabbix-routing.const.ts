...
import { ZabbixLoadbalancerDetailsComponent } from './zabbix-loadbalancer-details/zabbix-loadbalancer-details.component';
...
export const ZABBIX_LOADBALANCERS_ROUTES: Routes = [
  {
    path: 'details',
    component: ZabbixLoadbalancerDetailsComponent,
    data: {
      breadcrumb: {
        title: 'Details',
        stepbackCount: 0
