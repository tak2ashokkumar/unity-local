...
@Component({
  selector: 'loadbalancers-zabbix',
  templateUrl: './loadbalancers-zabbix.component.html',
  styleUrls: ['./loadbalancers-zabbix.component.scss']
})
export class LoadbalancersZabbixComponent implements OnInit, OnDestroy {
