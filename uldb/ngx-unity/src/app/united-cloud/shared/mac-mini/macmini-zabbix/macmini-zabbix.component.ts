...
@Component({
  selector: 'macmini-zabbix',
  templateUrl: './macmini-zabbix.component.html',
  styleUrls: ['./macmini-zabbix.component.scss']
})
export class MacminiZabbixComponent implements OnInit, OnDestroy {
