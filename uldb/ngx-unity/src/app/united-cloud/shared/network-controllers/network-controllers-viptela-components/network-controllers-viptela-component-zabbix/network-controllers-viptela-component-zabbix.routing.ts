...
import { ZabbixNetworkControllersViptelaComponentDetailsComponent } from "./zabbix-network-controllers-viptela-component-details/zabbix-network-controllers-viptela-component-details.component";

export const ZABBIX_VIPTELA_DEVICE_ROUTES: Routes = [
    {
        path: 'details',
        component: ZabbixNetworkControllersViptelaComponentDetailsComponent,
        data: {
            breadcrumb: {
                title: 'Details',
                stepbackCount: 0
