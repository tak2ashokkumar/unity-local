...
@Injectable()
export class ZabbixNetworkControllersViptelaComponentDetailsService {

  constructor(private http: HttpClient,
    private utilSvc: AppUtilityService,
    private builder: FormBuilder) { }

  getDeviceDetails(deviceId: string): Observable<ViptelaDeviceType> {
    return this.http.get<ViptelaDeviceType>(DEVICE_BY_ID(DeviceMapping.VIPTELA_DEVICE, deviceId));
  }

  buildDetailForm(d: ViptelaDeviceType): FormGroup {
  ...
  buildMetaDataForm(d: ViptelaDeviceType): FormGroup {
    return this.builder.group({
  ...
  buildCertificateForm(d: ViptelaDeviceType): FormGroup {
    return this.builder.group({
