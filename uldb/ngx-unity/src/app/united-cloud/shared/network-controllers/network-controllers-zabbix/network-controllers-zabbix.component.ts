...
@Component({
  selector: 'network-controllers-zabbix',
  templateUrl: './network-controllers-zabbix.component.html',
  styleUrls: ['./network-controllers-zabbix.component.scss']
})
export class NetworkControllersZabbixComponent implements OnInit, OnDestroy {
