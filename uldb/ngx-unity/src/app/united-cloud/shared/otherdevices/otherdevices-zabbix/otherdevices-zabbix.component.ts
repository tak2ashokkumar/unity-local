...
@Component({
  selector: 'otherdevices-zabbix',
  templateUrl: './otherdevices-zabbix.component.html',
  styleUrls: ['./otherdevices-zabbix.component.scss']
})
export class OtherdevicesZabbixComponent implements OnInit, OnDestroy {
