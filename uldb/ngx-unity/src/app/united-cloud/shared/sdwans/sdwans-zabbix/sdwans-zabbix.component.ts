...
@Component({
  selector: 'sdwans-zabbix',
  templateUrl: './sdwans-zabbix.component.html',
  styleUrls: ['./sdwans-zabbix.component.scss']
})
export class SdwansZabbixComponent implements OnInit {
  ...
  ngOnDestroy() {
    ...
    // const zbxChildRoutesPathSegments: string[] = ['monitoring-graphs', 'manage-graphs', 'events', 'triggers', 'configure', 'crud', 'scripts'];
    // if (!zbxChildRoutesPathSegments.includes(this.router.url.split('/').getLast())) {
