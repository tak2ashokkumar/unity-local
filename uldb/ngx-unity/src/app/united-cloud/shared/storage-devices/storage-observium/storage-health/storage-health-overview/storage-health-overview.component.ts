...
@Component({
  selector: 'storage-health-overview',
  templateUrl: './storage-health-overview.component.html',
  styleUrls: ['./storage-health-overview.component.scss']
})
export class StorageHealthOverviewComponent implements OnInit {

  graphConfig: DeviceGraphType[] = STORAGEDEVICE_OBSERVIUM_GRAPH.HEALTHGRAPHS['OVERVIEW'];
  deviceId: string;
