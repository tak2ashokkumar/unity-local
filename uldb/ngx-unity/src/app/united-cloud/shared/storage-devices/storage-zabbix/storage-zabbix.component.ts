...
@Component({
  selector: 'storage-zabbix',
  templateUrl: './storage-zabbix.component.html',
  styleUrls: ['./storage-zabbix.component.scss']
})
export class StorageZabbixComponent implements OnInit, OnDestroy {
