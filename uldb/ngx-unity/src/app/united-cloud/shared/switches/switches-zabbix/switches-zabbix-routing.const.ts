...
import { ZabbixSwitchDetailsComponent } from './zabbix-switch-details/zabbix-switch-details.component';
import { DeviceOverviewComponent } from "../../device-overview/device-overview.component";

export const ZABBIX_SWITCH_ROUTES: Routes = [
  {
    path: 'details',
    component: ZabbixSwitchDetailsComponent,
    data: {
      breadcrumb: {
        title: 'Details',
        stepbackCount: 0
