...
@Component({
  selector: 'vms-graph-poller',
  templateUrl: './vms-graph-poller.component.html',
  styleUrls: ['./vms-graph-poller.component.scss']
})
export class VmsGraphPollerComponent implements OnInit {

  graphConfig: DeviceGraphType[] = VMS_OBSERVIUM_GRAPH.GRAPH['POLLER'];
  deviceId: string;
