...
import { AwsVisNetworkService } from './aws-vis-network.service';
...
@Component({
  selector: 'aws-vis-network',
  templateUrl: './aws-vis-network.component.html',
  styleUrls: ['./aws-vis-network.component.scss'],
  providers: [AwsVisNetworkService]
})
export class AwsVisNetworkComponent implements OnInit, OnDestroy {
  ...
  constructor(private renderer: Renderer2,
    ...
    private visService: AwsVisNetworkService,
  ...
  getNodes() {
    this.visService.getNetworkData(this.accountId, this.regionId, this.meshName).pipe(takeUntil(this.ngUnsubscribe)).subscribe(res => {
