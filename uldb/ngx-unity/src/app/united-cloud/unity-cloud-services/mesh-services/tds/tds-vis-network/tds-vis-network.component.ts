...
import { TdsVisNetworkService } from './tds-vis-network.service';
...
@Component({
  selector: 'tds-vis-network',
  templateUrl: './tds-vis-network.component.html',
  styleUrls: ['./tds-vis-network.component.scss'],
  providers: [TdsVisNetworkService]
})
export class TdsVisNetworkComponent implements OnInit, OnDestroy {
  ...
  constructor(private renderer: Renderer2,
    ...
    private visService: TdsVisNetworkService,
  ...
  getNodes() {
    this.visService.getNetworkData(this.meshId, this.serviceName).pipe(takeUntil(this.ngUnsubscribe)).subscribe(res => {
