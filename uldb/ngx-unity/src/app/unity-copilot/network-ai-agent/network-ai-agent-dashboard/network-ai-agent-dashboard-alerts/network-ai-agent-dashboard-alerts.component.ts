...
import { AIMLAlertsViewdata, NetworkAiAgentDashboardAlertsService } from './network-ai-agent-dashboard-alerts.service';
...
@Component({
  ...
  styleUrls: ['./network-ai-agent-dashboard-alerts.component.scss'],
  providers: [NetworkAiAgentDashboardAlertsService]
})
export class NetworkAiAgentDashboardAlertsComponent implements OnInit {
  ...
  constructor(private alertSvc: NetworkAiAgentDashboardAlertsService,
