...
import { AIMLAlerts, AIMLSuppressedDisableTriggerType, AIMLSuppressedEvents, AIMLSuppressedResolveType } from './network-ai-agent-dashboard-alerts.type';
...
@Injectable()
export class NetworkAiAgentDashboardAlertsService {
