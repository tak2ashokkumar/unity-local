...
import { AppUtilityService, DeviceMapping, NoWhitespaceValidator, UnityDeviceType } from 'src/app/shared/app-utility/app-utility.service';
import { TableColumnMapping } from 'src/app/shared/SharedEntityTypes/unity-utils.type';
import { TableApiServiceService } from 'src/app/shared/table-functionality/table-api-service.service';
import { AIMLEventResolveType, AIMLEvents } from './network-ai-agent-dashboard-events.type';
...
@Injectable()
export class NetworkAiAgentDashboardEventsService {
