export interface ManageReportCloudInventoryType {
    ...
    cloud_uuid: string;
    cloud: 'AWS' | 'GCP' | 'AZURE';
    vm: ManageReportPublicCloudInventoryVMType[];
...
export interface ManageReportPublicCloudInventoryVMType extends ManageReportCloudInventoryVMType {
    region: string;
}

export interface ManageReportPublicCloudData {
    cloudType: string[];
    cloud: string[];
    cloudName: ManageReportPublicCloudCloudNameData[];
    report_url: string;
}

export interface ManageReportPublicCloudCloudNameData {
    name: string;
    uuid: string;
