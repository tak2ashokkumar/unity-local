...
import { ManageReportViewData, ManageReportsService, } from './manage-reports.service';
import { takeUntil } from 'rxjs/operators';
import { Subject } from 'rxjs';
import { BsModalRef, BsModalService } from 'ngx-bootstrap/modal';
import { AppNotificationService } from 'src/app/shared/app-notification/app-notification.service';
import { Notification } from 'src/app/shared/app-notification/notification.type';
import { ManageReportSummaryCountDataType } from './manage-reports.type';
...
@Component({
  ...
  // providers: [ManageReportsService]
})
export class ManageReportsComponent implements OnInit, OnDestroy {
  ...
  constructor(private renderer: Renderer2,
    ...
    private reportSvc: ManageReportsService,
  ...
  goToPreview(view: ManageReportViewData) {
    this.router.navigate(['reports', this.feature, view.uuid, 'preview'], { relativeTo: this.route.parent });
  }
