...
import { ReportManagementDcInventoryPreviewService } from './dc-inventory-preview.service';

/**
 * Coordinates the Report Management Dc Inventory Preview screen state, template bindings, and user actions.
 */
@Component({
  selector: 'report-management-dc-inventory-preview',
  templateUrl: './dc-inventory-preview.component.html',
  styleUrls: ['./dc-inventory-preview.component.scss'],
  providers: [ReportManagementDcInventoryPreviewService],
})
export class ReportManagementDcInventoryPreviewComponent implements OnInit {
  /**
  ...
  constructor(
    private svc: ReportManagementDcInventoryPreviewService,
  ...
  /**
   * Initializes Report Management Dc Inventory Preview Component data and subscriptions.
   *
   * @returns Nothing.
   */
  ngOnInit(): void {
    this.spinnerService.start('main');
    // DC preview keeps column metadata separate from paginated row data.
    this.getColumns();
  ...
  /**
   * Executes the page change workflow for Report Management Dc Inventory Preview Component.
   *
  ...
  /**
   * Executes the refresh data workflow for Report Management Dc Inventory Preview Component.
   *
   * @param pageNo - Page No value used by this method.
   * @returns Nothing.
   */
  ...
  /**
   * Executes the page size change workflow for Report Management Dc Inventory Preview Component.
   *
  ...
  /**
   * Releases Report Management Dc Inventory Preview Component subscriptions and pending UI work.
   *
   * @returns Nothing.
   */
  ngOnDestroy(): void {
  ...
  /**
   * Executes the column change workflow for Report Management Dc Inventory Preview Component.
   *
   * @returns Nothing.
   */
  columnChange() {
