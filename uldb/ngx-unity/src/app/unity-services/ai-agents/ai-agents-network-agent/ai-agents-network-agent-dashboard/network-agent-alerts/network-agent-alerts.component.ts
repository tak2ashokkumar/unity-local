...
import { AIMLAlertsViewdata, NetworkAgentAlertsService } from './network-agent-alerts.service';
import { Subject } from 'rxjs';
import { PAGE_SIZES, SearchCriteria } from 'src/app/shared/table-functionality/search-criteria';
import { AIMLAlertsSummary } from './network-agent-alerts.type';
...
@Component({
  selector: 'network-agent-alerts',
  templateUrl: './network-agent-alerts.component.html',
  styleUrls: ['./network-agent-alerts.component.scss'],
  providers: [NetworkAgentAlertsService]
})
export class NetworkAgentAlertsComponent implements OnInit {
  ...
  constructor(private alertSvc: NetworkAgentAlertsService,
