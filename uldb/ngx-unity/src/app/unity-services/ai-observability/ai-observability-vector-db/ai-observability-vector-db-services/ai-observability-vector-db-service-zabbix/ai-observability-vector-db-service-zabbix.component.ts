...
@Component({
  selector: 'ai-observability-vector-db-service-zabbix',
  templateUrl: './ai-observability-vector-db-service-zabbix.component.html',
  styleUrls: ['./ai-observability-vector-db-service-zabbix.component.scss']
})
export class AiObservabilityVectorDbServiceZabbixComponent implements OnInit, OnDestroy {
