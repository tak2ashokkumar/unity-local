...
@Component({
  selector: 'wf-dynamic-help-panel',
  templateUrl: './wf-dynamic-help-panel.component.html',
  styleUrls: ['./wf-dynamic-help-panel.component.scss']
})
export class WfDynamicHelpPanelComponent implements OnInit {
