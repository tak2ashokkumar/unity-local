...
import { NagiosInstanceType } from './usi-event-ingestion-nagios-crud.type';
import { RxwebValidators } from '@rxweb/reactive-form-validators';

@Injectable()
export class UsiEventIngestionNagiosCrudService {
  ...
  //   if (uuid) {
  //     return this.http.get<NagiosInstanceType>(`customer/aiops/event-ingestion-instance/${uuid}/`).pipe(
  //       map(data => {
  ...
  // addInstance(obj: NagiosInstanceType) {
  //   return this.http.post(ADD_NAGIOS_INSTANCE(), obj);
  // }

  // updateInstance(obj: NagiosInstanceType, uuid: string) {
