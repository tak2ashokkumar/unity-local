...
import { AdvancedDiscoveryMacdevicesService, DevDisMacMiniViewdata, DeviceDiscoveryMacMiniFormData } from './advanced-discovery-macdevices.service';

@Component({
  selector: 'advanced-discovery-macdevices',
  templateUrl: './advanced-discovery-macdevices.component.html',
  styleUrls: ['./advanced-discovery-macdevices.component.scss'],
  providers: [AdvancedDiscoveryMacdevicesService]
})
export class AdvancedDiscoveryMacdevicesComponent implements OnInit, OnDestroy {
  ...
  constructor(private utilService: AppUtilityService,
    ...
    private deviceDiscoveryService: AdvancedDiscoveryMacdevicesService) { }
  ...
  getCabinets(data: DevDisMacMiniViewdata) {
  ...
  getPrivateClouds(data: DevDisMacMiniViewdata) {
    let selectedDcId = data.form.get('datacenter.uuid').value;
    data.clouds = [];
