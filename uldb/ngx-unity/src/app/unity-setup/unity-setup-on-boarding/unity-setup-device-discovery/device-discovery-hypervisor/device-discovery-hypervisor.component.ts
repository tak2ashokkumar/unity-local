...
import { DevDisHypervisorViewdata, DeviceDiscoveryHypervisorFormData, DeviceDiscoveryHypervisorService } from './device-discovery-hypervisor.service';

@Component({
  selector: 'device-discovery-hypervisor',
  templateUrl: './device-discovery-hypervisor.component.html',
  styleUrls: ['./device-discovery-hypervisor.component.scss'],
  providers: [DeviceDiscoveryHypervisorService]
})
export class DeviceDiscoveryHypervisorComponent implements OnInit, OnDestroy {
  ...
  privateClouds: Array<HypervisorCRUDPrivateCloudFast> = [];
  ...
  constructor(private utilService: AppUtilityService,
    ...
    private deviceDiscoveryService: DeviceDiscoveryHypervisorService) { }
