...
import { DevDisServerViewdata, DeviceDiscoveryServersService } from './device-discovery-servers.service';

@Component({
  selector: 'device-discovery-servers',
  templateUrl: './device-discovery-servers.component.html',
  styleUrls: ['./device-discovery-servers.component.scss'],
  providers: [DeviceDiscoveryServersService]
})
export class DeviceDiscoveryServersComponent implements OnInit, OnDestroy {
  ...
  privateClouds: Array<BMServerCRUDPrivateCloudFast> = [];
  ...
  constructor(private utilService: AppUtilityService,
    ...
    private deviceDiscoveryService: DeviceDiscoveryServersService) { }
