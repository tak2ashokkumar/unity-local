...
import { atLeastOneFieldRequiredValidator, commaSeparatedValidator, POLICY_TYPE_LIST, PolicyType, regexSyntaxValidator, ScopeIdentifierListViewData } from './unity-setup-policy-policies-crud.service';
import { UnitySetupPolicyPoliciesCrudService } from './unity-setup-policy-policies-crud.service';

@Component({
  selector: 'unity-setup-policy-policies-crud',
  templateUrl: './unity-setup-policy-policies-crud.component.html',
  styleUrls: ['./unity-setup-policy-policies-crud.component.scss'],
  providers: [UnitySetupPolicyPoliciesCrudService]
})
export class UnitySetupPolicyPoliciesCrudComponent implements OnInit, OnDestroy {
  ...
  constructor(private route: ActivatedRoute,
    ...
    private policyCrudService: UnitySetupPolicyPoliciesCrudService, private utilityService: AppUtilityService,
  ...
  onSubmit() {
    if (this.form.invalid) {
      ...
      else if (this.form.errors && this.form.errors.notifyUserOrGroupRequired) {
        this.formErrors.notifyUserOrGroupRequired = 'At least one of "User" or "Group" must be selected when notifications are enabled';
      }
