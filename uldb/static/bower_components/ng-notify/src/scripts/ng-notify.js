...
(function() {
    ...
    function ngNotifyCache($templateCache) {
        ...
        var html =
            '<div class="ngn ngn-custom ngn-zindex" ng-class="ngNotify.notifyClass">' +
                ...
                '<span ng-show="ngNotify.notifyButton" class="ngn-dismiss ngn-dismiss-custom" ng-click="dismiss()">&times;</span>' +
            '</div>';
