...
app.controller('VMWareMenuController', [
    '$scope',
    '$rootScope',
    '$state',
    '$stateParams',
    ...
    function ($scope, $rootScope, $state, $stateParams, $timeout, $http, $location) {
        console.log("VMWareMenuController");
        ...
        if (angular.isDefined(stateParams) && (stateParams !== null)) {
            $scope.vmware_vm_id = stateParams;
        } else {
            return;
        }
        ...
        var get_vmware_vm_details = function () {
            $http({
                method: "GET",
                url: '/customer/observium/vmware/' + $scope.vmware_vm_id + '/get_device_data/'
        ...
        $scope.getDetailedView = function (vmware_vms_graph_obj) {
            ...
            $http({
                method: "GET",
                url: '/customer/observium/vmware/' + $scope.vmware_vm_id + '/get_graph_by_type/',
                params: params,
            }).then(function (response) {
...
app.controller('VMWareOverviewController', [
    '$scope',
    '$state',
    '$stateParams',
    '$timeout',
    ...
    function ($scope, $state, $stateParams, $timeout, $http, $location, OberviumGraphConfig) {
        console.log(' in VMWareOverviewController ');

        var get_status_data = function () {
            $http({
                method: "GET",
                url: '/customer/observium/vmware/' + $scope.vmware_vm_id + '/get_status_data'
            }).then(function (response) {
        ...
        var get_sensor_data = function () {
            $http({
                method: "GET",
                url: '/customer/observium/vmware/' + $scope.vmware_vm_id + '/get_sensor_data'
            }).then(function (response) {
...
app.controller('VMWareGraphController', [
    '$scope',
    '$state',
    '$stateParams',
    '$timeout',
    ...
    function ($scope, $state, $stateParams, $timeout, $http, $location, OberviumGraphConfig) {
        ...
        console.log(' in VMWareGraphController ');
        $scope.submenutabs = [
            {
                'tabname': 'Netstats',
        ...
        var get_vmware_vm_graphs = function (graphconfig, graphnameconfig) {
            ...
            $http({
                method: "GET",
                url: '/customer/observium/vmware/' + $scope.vmware_vm_id + '/get_graph_set_by_type/',
                params: params
            }).then(function (response) {
...
app.controller('VMWareHealthStatsController', [
    '$scope',
    '$state',
    '$stateParams',
    '$timeout',
...
app.controller('VMWarePortsController', [
    '$scope',
    '$state',
    '$stateParams',
    '$timeout',
    ...
    function ($scope, $state, $stateParams, $timeout, $http, $location) {
        console.log('in VMWarePortsController with VMware : ', $scope.vmware_vm_id);
        ...
        $scope.getPortGraphs = function (port) {
            ...
            $http({
                method: "GET",
                url: '/customer/observium/vmware/' + $scope.vmware_vm_id + '/get_port_details_graph_set/',
                params: params
            }).then(function (response) {
        ...
        var get_port_data = function () {
            $http({
                method: "GET",
                url: '/customer/observium/vmware/' + $scope.vmware_vm_id + '/get_device_port_details/',
            }).then(function (response) {
...
app.controller('VMWareLogsController', [
    '$scope',
    '$state',
    '$stateParams',
    '$timeout',
    ...
    '$location',
    function ($scope, $state, $stateParams, $timeout, $http, $location) {
        console.log('in VMWareLogsController with Vmware : ', $scope.vmware_vm_id);
    }
]);

app.controller('VMWareAlertsController', [
    '$scope',
    '$state',
    '$stateParams',
    '$timeout',
    ...
    '$location',
    function ($scope, $state, $stateParams, $timeout, $http, $location) {
        console.log('in VMWareAlertsController with VMware vm : ', $scope.vmware_vm_id);
        $scope.vmware_vm_alerts = {};

        var get_vmware_vm_alerts = function (graphconfig) {
            $http({
                method: "GET",
                url: '/customer/observium/vmware/' + $scope.vmware_vm_id + '/get_alert_data/',
            }).then(function (response) {
