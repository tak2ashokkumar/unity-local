...
app.controller('AzureDashboardController', [
    ...
    function ($scope,
        ...
        $scope.users = [];
        UserFast.query().$promise.then(function (success) {
            angular.forEach(success.results, function (value, key) {
                $scope.users.push({ short: value.id, long: value.email });
            });
        }).catch(function (error) {
            console.log(error);
        });

        // AzureService.get_azure_location().then(function(result){
        ...
        var load_dashboard = function load_dashboard() {
            ...
            AzureService.get_azure_content_data().then(function (result) {
                ...
                $scope.azure_content_rows = [
                    ...
                    DataFormattingService.generate_row(["select", "user", "User", $scope.users, "required"]),
        ...
        $scope.list_resource_grps = function (args) {
            ...
            $location.path("/azure/" + args.id + "/resource_group/");
        };
        ...
        $scope.azure_account_add = function (params) {
            ...
            var url = AdminApi.azure_account;
...
//        };
        ...
        $scope.azure_edit = function (params) {
            ...
            var url = AdminApi.azure_edit.replace(":account_id", params.id);
        ...
        $scope.azure_delete = function (params) {
            ...
            var url = AdminApi.azure_delete.replace(":account_id", params.id);
