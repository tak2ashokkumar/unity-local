...
app.controller('AllDatacenterController', [
    '$scope',
    '$routeParams',
    '$rootScope',
    '$q',
...
app.controller('AllPrivateCloudController', [
    '$scope',
    '$routeParams',
    '$rootScope',
    '$q',
    ...
    function ($scope,
        ...
        CustomDataService.get_private_clouds_data().then(function (result) {
...
app.controller('AllPublicCloudController', [
    '$scope',
    '$routeParams',
    '$rootScope',
    '$q',
    ...
    function ($scope,
        ...
        CustomDataService.get_public_clouds_data().then(function (result) {
...
app.controller('AllColocationController', [
    '$scope',
    '$routeParams',
    '$rootScope',
    '$q',
    ...
    function ($scope,
        ...
        CustomDataService.get_colocations_data().then(function (result) {
