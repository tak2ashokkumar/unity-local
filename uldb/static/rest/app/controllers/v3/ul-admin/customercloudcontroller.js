...
app.controller('CustomerDatacenterController', [
    '$scope',
    '$routeParams',
    '$rootScope',
    '$q',
    ...
    function (
        ...
        DataFormattingService) {
            ...
            CustomDataService.get_customer_datacenter($routeParams.id).then(function (result) {
...
app.controller('CustomerPrivateCloudController', [
    ...
    function (
        ...
        DataFormattingService) {
            ...
            CustomDataService.get_customer_private_clouds($routeParams.id).then(function (result) {
...
app.controller('CustomerPublicCloudController', [
    '$scope',
    '$routeParams',
    '$rootScope',
    '$q',
    ...
    function (
        ...
        DataFormattingService) {
            ...
            CustomDataService.get_customer_public_clouds($routeParams.id).then(function (result) {
...
app.controller('CustomerColocationController', [
    '$scope',
    '$routeParams',
    '$rootScope',
    '$q',
    ...
    function (
        ...
        DataFormattingService) {
            ...
            CustomDataService.get_customer_colocations($routeParams.id).then(function (result) {
